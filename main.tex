...
\supervisorAmail{marta.fort@udg.edu}         % Email address of supervisor 1,      \supmailA %            \supwebA
...
\supervisorB{Maria Jimenez Molina}              % Name of supervisor 2,               \supnameB
\supervisorBmail{marijimo67@gmail.com}       % Email address of supervisor 2,      \supmailB               % \supwebB
\supervisorBinfo{                       % Formatted info about supervisor 2:  \supinfoB
    \supnameB\\
    Email: \href{mailto:\supmailB}{\supmailB}\\
    Tel.: \href{+34650121367}{+34650121367}
}
...
\include{Capitols/Chapter1}
\include{Capitols/Chapter2}
\include{Capitols/Chapter3}
%\include{Capitols/ChapterTemplate} 
%\include{Chapters/Chapter3}
\include{Capitols/Chapter4} 
\include{Capitols/Chapter5} 
\include{Capitols/Chapter6}
\include{Capitols/Chapter7}
\include{Capitols/Chapter8}
\include{Capitols/Chapter9}
\include{Capitols/Chapter10}
\include{Capitols/Chapter11}
\include{Capitols/Chapter12}

%----------------------------------------------------------------------------------------
% BIBLIOGRAPHY
%----------------------------------------------------------------------------------------
\nocite{responsive_framework_pub, flutter_adaptive_responsive, flutter_responsive_video, flexbox_froggy, firebase_database_docs}
...
\include{Apendix/AppendixA}
\include{Apendix/AppendixB}
\include{Apendix/AppendixC}
