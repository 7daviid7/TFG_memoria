...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        % 2022 Node
        \draw (1,0.2) -- (1,-0.2);
        \node[align=center, below] at (1,-0.3) {\textbf{2022} \\ Inici del Projecte \\ (Aprenentatge Dart \\ + Desenvolupament Base)};
        
        % 2023 Node
        \draw (5,0.2) -- (5,-0.2);
        \node[align=center, below] at (5,-0.3) {\textbf{2023 - 2025} \\ Pausa en el \\ desenvolupament};
...
\subsection{Fase 1: Fonaments i Aprenentatge (2022-2023)}
El projecte va néixer l'any 2022 amb una visió clara però amb un repte tècnic important: el desconeixement del llenguatge de programació escollit, Dart (i el framework Flutter).
