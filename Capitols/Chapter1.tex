...
\section{Introducció}
Aquest document presenta el desenvolupament tècnic de \textbf{NUMEN}, un sistema informàtic dissenyat per a l'automatització d'estudis numerològics complexos. El projecte aborda la transformació d'un procés manual, propens a errors i ineficient, en una solució de programari robusta, escalable i precisa.
