...
If you are writing a thesis (or will be in the fudsasadfature) and its subject is technical or mathematical (though it doesn't have to be), then creating it in \LaTeX{} is highly recommended as a way to make sure you can just get down to the essential writing without having to worry over formatting or wasting time arguing with your word processor.
...
It is recommended to take a little time out to learn how sfasdfto use \LaTeX{} by creating several, small `test' documents, or having a close look at several templates on:\\ 
...
You can use this page as a reference or crib ssafasdeet, the symbols are rendered as large, high quality images so you can quickly find the \LaTeX{} command for the symbol you need.
...
If you are new to \LaTeX{} it is recommenddsafased that you carry on reading through the rest of the information in this document.
