...
Aquest projecte es defineix com una iniciativa individual, desenvolupada íntegrament des de zero per l'autor. L'origen del programari es remunta a l'any 2022, naixent d'una motivació personal per automatitzar els càlculs numerològics que la meva mare realitzava manualment. Aquesta gènesi particular atorga al projecte una naturalesa híbrida: tot i ser un treball acadèmic, respon a les necessitats reals d'un ``client'' final expert en el domini.
...
A continuació es detallen els algoritmes i estructures de dades principals que conformen el nucli matemàtic de l'aplicació.
