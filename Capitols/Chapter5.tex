...
\begin{itemize}
    ...
    \item \textbf{IDE:} Visual Studio Code com a entorn de desenvolupament inicial. Posteriorment i durant l'etapa de PFG, s'ha utilitzat \textbf{Antigravity} (una versió avançada de VS Code amb IA agentic integrada) per accelerar la refactorització i documentació del codi.
