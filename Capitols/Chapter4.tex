...
El desenvolupament del projecte es divideix en dues fases temporals diferenciades. A continuació es mostren els cronogrames corresponents a la fase inicial (2022) i la fase de finalització com a TFG (2025-2026).

\begin{figure}[H]
    \centering
    \caption{Fase 1: Desenvolupament Inicial (2022)}
    ...
    \begin{ganttchart}[
        ...
        % Phase 1
        \ganttgroup[name=p1_total]{Fase 1: Desenvolupament}{2022-10-01}{2023-01-31} \\
        \ganttbar[name=p1_analisi]{Anàlisi i Requisits}{2022-10-01}{2022-10-31} \\
        \ganttbar[name=p1_disseny]{Disseny}{2022-11-01}{2022-11-15} \\
        \ganttbar[name=p1_nucli]{Nucli i Algoritmes}{2022-11-15}{2022-12-31} \\
        \ganttbar[name=p1_front]{Frontend Inicial}{2022-12-15}{2023-01-31} \\
