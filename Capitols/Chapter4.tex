...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.25\textwidth}|p{0.70\textwidth}|}
        \hline
        \rowcolor{gray!20} \textbf{Nom del paquet} & \textbf{PT1: FONAMENTS I ALGORÍSMICA} \\ \hline
...
\subsection{Etapa 2: Professionalització (TFG 2025)}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.25\textwidth}|p{0.70\textwidth}|}
        ...
        \begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
            ...
            \item Implementació de la base de dades Firestore.
            \item Definició de regles de seguretat (Restricció d'origen API).
        \end{itemize} \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.25\textwidth}|p{0.70\textwidth}|}
        \hline
        \rowcolor{gray!20} \textbf{Nom del paquet} & \textbf{PT6: GESTIÓ I MEMÒRIA} \\ \hline
        \textbf{Descripció} & Documentació acadèmica i gestió del TFG. \\ \hline
        \textbf{Tasques} & 
        \begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
        ...
        \end{itemize} \\ \hline
        \textbf{Lliuraments} & Memòria final del TFG. \\ \hline
...
\begin{figure}[H]
    \centering
    \caption{Fase 2: TFG i Professionalització (2025-2026)}
    ...
    \begin{ganttchart}[
        ...
        \ganttbar{PT6: Memòria}{2025-09-01}{2026-01-20} \\
        \ganttlink{elem0}{elem1}
