...
Tot i que el cost monetari directe és nul, cal considerar el \textbf{cost teòric de desenvolupament}, calculat en base a les hores d'enginyeria dedicades. Si s'estimés un preu de mercat per hora de desenvolupament júnior (aprox. 8-12 €/h) i una dedicació de 400 hores (crèdits ECTS + treball autònom), la inversió teòrica rondaria els 3.200€- 4.800€. Aquest cost, però, és assumit com a inversió acadèmica i personal.
