...
S'ha verificat visualment la generació del PDF assegurant:
\begin{itemize}
    \item Que la paginació s'adapta al format A4 horitzontal.
    \item Que els caràcters especials (accents, ç) es renderitzen correctament.
    \item Que el gràfic vectorial de la figura manté els colors dinàmics en la versió impresa.
\end{itemize}
